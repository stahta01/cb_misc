...
mkdir -p wxMSW-3.0.1_gcc630MSYS2_lib_Dev/lib
cp --recursive --update --preserve lib/gcc630MSYS2_lib wxMSW-3.0.1_gcc630MSYS2_lib_Dev/lib/

7za u wxMSW-3.0.1_gcc630MSYS2_lib_Dev.7z wxMSW-3.0.1_gcc630MSYS2_lib_Dev/
