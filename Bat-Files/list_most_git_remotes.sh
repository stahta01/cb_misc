...
cd ../codeblocks_r7456 && git remote -v && \
# cd ../codeblocks_msys2 && git remote get-url cb_msys2 &&
# cd ../msys2_wx_config_exe && git remote -v &&
# cd ../wx-config-win && git remote -v &&
cd ../wxTortoiseGit && git remote -v && \
cd ../wxWidgets && git remote -v && \
cd ../passwordsafe_git_code && git remote -v
